    ...
    render(ctx, playerLifes = 0, towers = [], enemies = []) {
        ...
        for (let r = startRow; r < endRow; r++) {
            for (let c = startCol; c < endCol; c++) {
                ...
                if (tok === 'SNW' || tok === 'M' || tok === 'O[SNW]' || tok === 'SNW[SPIKE-1]' || tok === 'SNW[SPIKE-2]' || tok === 'SNW[SPIKE-3]' || tok === 'SNW[SPIKE-4]' || tok === 'SNW[Snowman]') {
                    if (!this.snowTexture)
                        this.snowTexture = (
                ...
                } else if (tok === 'SND' || tok === 'O[SND]' || tok === 'SND[BONE-1]' || tok === 'SND[BONE-2]' || tok === 'SND[BONE-3]' || tok === 'SND[BONE-4]' || tok === 'SND[CACTUS-1]' || tok === 'SND[CACTUS-2]' || tok === 'SND[CACTUS-3]' || tok === 'SND[CACTUS-4]' || tok === 'SND[PALM-1]' || tok === 'SND[PALM-2]' || tok === 'SND[PALM-3]' || tok === 'SND[PALM-4]') {
                    if (!this.sandTexture)
                        this.sandTexture = (
                            this.graphicsSettings.terrain === 'low'
                                ? this._preRenderSandLow(this.tileSize)
